...
export function FinalCTA() {
  return (
    <section className="relative overflow-hidden border-b border-white/10 bg-black px-5 py-11 text-white sm:px-8 lg:px-12">
      ...
      <div className="relative mx-auto flex max-w-7xl animate-fade-up flex-col items-center justify-between gap-8 rounded-md border border-white/[0.07] bg-black/28 px-6 py-8 text-center shadow-[0_22px_60px_rgba(0,0,0,0.36)] md:flex-row md:px-9 md:text-left lg:px-12">
        <div className="max-w-3xl">
          <p className="text-[0.72rem] font-black uppercase tracking-[0.22em] text-laser">
            Pronto para começar?
          </p>
          <h2 className="mt-3 text-balance text-[1.7rem] font-black leading-tight text-white sm:text-[2.25rem] lg:text-[2.7rem]">
        ...
        <div className="flex w-full flex-col gap-3 sm:w-auto sm:min-w-[260px]">
          ...
          <Link
            href={headerCta.href}
            className="inline-flex min-h-[50px] items-center justify-center gap-3 rounded border border-laser/70 bg-black/30 px-8 py-3.5 text-xs font-black uppercase tracking-normal text-white transition duration-300 hover:bg-laser/10 hover:shadow-[0_0_24px_rgba(225,18,27,0.18)]"
          >
            Falar no WhatsApp
          </Link>
        </div>
