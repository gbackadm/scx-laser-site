...
export function Hero() {
  return (
    ...
    >
      ...
      <div className="mx-auto grid min-h-[540px] max-w-7xl items-center px-5 py-12 sm:px-8 md:min-h-[430px] lg:min-h-[315px] lg:grid-cols-[430px_1fr] lg:px-12 lg:py-8">
        <div className="max-w-[430px] animate-fade-up">
          <h1 className="text-balance text-[3.05rem] font-black uppercase leading-[0.94] tracking-normal text-zinc-100 sm:text-[3.8rem] lg:text-[4.05rem]">
            Gravação a
          ...
          <p className="mt-3 max-w-[360px] text-base leading-7 text-zinc-100 sm:text-lg">
            Precisão, qualidade e acabamento profissional em diversos materiais.
          </p>

          <div className="mt-6 flex flex-col gap-3 text-[0.82rem] text-zinc-200 sm:flex-row sm:flex-wrap sm:items-center sm:gap-5">
              ...
              <Link
                ...
                className={
                  button.variant === "primary"
                    ? "inline-flex min-h-[40px] items-center justify-center gap-2 rounded border border-red-400/50 px-6 py-3 text-xs font-black uppercase tracking-normal text-white shadow-laser transition hover:bg-red-600 sm:min-w-[182px]"
                    : "inline-flex min-h-[40px] items-center justify-center gap-2 rounded border border-steel/55 bg-black/25 px-6 py-3 text-xs font-black uppercase tracking-normal text-white transition hover:border-laser hover:bg-laser/10 hover:text-white sm:min-w-[166px]"
                }
                style={
                  button.variant === "primary"
